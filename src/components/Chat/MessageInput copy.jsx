...
import { generateTiptapJson, getBarCount, scaleDataToFit } from "./helper";
...
const MessageInput = ({ addMessageTest, messagesTest }) => {
  ...
  const createMessage = () => {
    ...
    const messageText = generateTiptapJson(messagesTest.length + 1);
    const messaage = {
      id: crypto.randomUUID(),
      content: messageText,
